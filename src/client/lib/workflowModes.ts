...
export const SEED_MATRIX_MODES: Record<SeedMatrixModeId, {
  ...
  batch: {
    ...
    navLabel: '批量选题储备',
    title: '批量选题储备',
    description: '一次性拉高种子数量，适合为一批素材快速生成更多选题储备。',
    buttonText: '生成储备策略',
  ...
  'hook-driven': {
    ...
    navLabel: '引流钩子策略',
    title: '引流钩子策略',
    description: '在策略生成时注入指定引流钩子方向，适合围绕强开头或强转化角度批量规划。',
    buttonText: '生成引流钩子策略',
...
export const DAILY_WRITER_MODES: Record<DailyWriterModeId, {
  ...
  batch: {
    ...
    navLabel: '批量稿件生产',
    title: '批量稿件生产',
    description: '选择生产稿件总数，系统会输出 1 篇主稿和 N-1 篇结构不同的稿件变体。',
    buttonText: '生产批量稿件',
    minTotal: 2,
    maxTotal: 6,
    defaultTotal: 6,
  ...
  'five-pack': {
    ...
    navLabel: '五篇内容包',
    title: '五篇内容包',
    description: '固定生产 5 篇稿件：1 篇主稿和 4 篇变体，适合一次性准备多版本内容。',
    buttonText: '生产五篇内容包',
    minTotal: 5,
    maxTotal: 5,
    defaultTotal: 5,
