...
export const AIWIKI_MODES: Record<AiwikiModeId, {
  ...
  'search-assets': {
    ...
    navLabel: '搜索入口生成',
    title: '搜索入口与关键词池生成',
    description: '围绕上传文章生成搜索入口、关键词池和可复用知识库资产，适合做 SEO/搜索流量规划。',
    buttonText: '生成搜索入口',
  ...
  full: {
    ...
    navLabel: '完整内容资产',
    title: '完整内容资产生成',
    description: '一次性生成生文材料、关键词池、搜索入口、选题资产和可跳转内容资产页。',
    buttonText: '生成完整资产',
    generateSearchAssets: true,
  },
}
...
export const SEED_MATRIX_MODES: Record<SeedMatrixModeId, {
  ...
  standard: {
    ...
    navLabel: '常规排期策略',
    title: '常规排期策略',
    description: '从内容资产库生成日常使用的选题策略表，适合常规内容排期。',
    buttonText: '生成排期策略',
  ...
  batch: {
    ...
    path: '/content-growth?stage=strategy&strategyMode=batch',
    navLabel: '批量选题储备',
    title: '批量选题储备',
    description: '一次性生成更多选题，适合为一批素材快速生成更多选题储备。',
    buttonText: '生成储备策略',
  ...
  'high-frequency': {
    ...
    path: '/content-growth?stage=strategy&strategyMode=high-frequency',
    navLabel: '高频发布排期',
    title: '高频发布排期',
  ...
  'hook-driven': {
    ...
    path: '/content-growth?stage=strategy&strategyMode=hook-driven',
    navLabel: '行动引导策略',
    title: '行动引导策略',
    description: '在策略生成时注入指定行动引导方向，适合围绕强开头或强转化角度批量规划。',
    buttonText: '生成行动引导策略',
...
export const DAILY_WRITER_MODES: Record<DailyWriterModeId, {
  ...
  single: {
    ...
    navLabel: '单篇主稿生产',
    title: '单篇主稿生产',
    description: '从选题策略中选择一个选题生产一篇主稿。',
    buttonText: '生产单篇主稿',
    minTotal: 1,
    maxTotal: 1,
    defaultTotal: 1,
  ...
  batch: {
    ...
    path: '/content-growth?stage=production&writerMode=batch',
    navLabel: '批量稿件生产',
    title: '批量稿件生产',
    description: '选择生产稿件总数，系统会输出 1 篇主稿和 N-1 篇结构不同的多版本稿件。',
    buttonText: '生产批量稿件',
    minTotal: 2,
    maxTotal: 6,
    defaultTotal: 6,
  ...
  'five-pack': {
    ...
    path: '/content-growth?stage=production&writerMode=five-pack',
    navLabel: '五篇内容包',
    title: '五篇内容包',
    description: '固定生产 5 篇稿件：1 篇主稿和 4 篇多版本稿件，适合一次性准备多版本内容。',
    buttonText: '生产五篇内容包',
    minTotal: 5,
    maxTotal: 5,
    defaultTotal: 5,
...
const topicEntries = [
  ['pain-point-topics', '痛点选题池', '从用户高频反馈问题，和未满足需求生成问题。', '生成痛点选题'],
  ['gap-opportunity-topics', '空白机会选题', '从竞品强弱关系的方向生成差异化选题。', '生成机会选题'],
  ['crossover-topics', '跨界灵感选题', '把宠物内容与生活方式、消费、教育等领域交叉生成新角度。', '生成跨界选题'],
  ['counterintuitive-topics', '反常识选题', '围绕颠覆认知的自媒体开头内容，生成高停留选题。', '生成反常识选题'],
  ['trend-topics', '热点追踪选题', '结合当日热点、行业新闻和平台话题生成实时时效选题。', '生成热点选题'],
