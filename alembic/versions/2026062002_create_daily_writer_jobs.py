...
def upgrade() -> None:
    ...
    op.create_index("ix_daily_writer_jobs_seed_id", "daily_writer_jobs", ["seed_id"])
    op.create_index("ix_daily_writer_jobs_status", "daily_writer_jobs", ["status"])
    op.create_index(
        "ix_daily_writer_jobs_created_at",
        "daily_writer_jobs",
        ["created_at"],
    )
